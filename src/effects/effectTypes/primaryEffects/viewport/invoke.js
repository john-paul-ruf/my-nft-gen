...
const draw = async (context, filename) => {
    ...
    await context.canvas.drawPolygon2d(thePolyGaston, context.data.center, 3, 270, context.data.thickness, context.data.innerColor, context.data.stroke + context.theAccentGaston, context.data.color)
