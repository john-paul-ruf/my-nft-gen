    ...
    static presets = [
        {
            ...
            percentChance: 100,
            currentEffectConfig: {
                warmth: new Range(0.05, 0.15),
                grainIntensity: new Range(0.02, 0.08),
                flickerSpeed: new Range(1, 3),
        ...
        },
        {
            ...
            percentChance: 100,
            currentEffectConfig: {
                warmth: new Range(0.3, 0.5),
                grainIntensity: new Range(0.15, 0.3),
                flickerSpeed: new Range(4, 10),
                flickerFindValueAlgorithm: getAllFindValueAlgorithms()
            }
        }
    ];
